...
namespace RepositoryLayer.Migrations
{
    ...
    [Migration("20210926064520_change1")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RepositoryLayer.Entity.Notes", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Color = "White",
                            CreatedDate = new DateTime(2021, 9, 26, 12, 15, 19, 625, DateTimeKind.Local).AddTicks(7192),
                            Image = "abc.jpg",
                            IsArchive = false,
                            IsNote = true,
                            IsPin = false,
                            ...
                            ModifiedDate = new DateTime(2021, 9, 26, 12, 15, 19, 627, DateTimeKind.Local).AddTicks(5859),
                            Title = "New Note",
                            UserId = 15
                        });
                });
            ...
            modelBuilder.Entity("RepositoryLayer.Entity.Notes", b =>
                {
                    b.HasOne("RepositoryLayer.Entity.User", null)
                        .WithMany("Notes")
